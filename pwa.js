...
const cacheName = 'LAWeek4YourName-2021-02-24 14:08:29.681643'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWeek4YourName'.length) === 'LAWeek4YourName') {
